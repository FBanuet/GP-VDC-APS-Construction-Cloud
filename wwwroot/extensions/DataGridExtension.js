...
class DataGridExtension extends BaseExtension {
    ...
    onToolbarCreated() {
        this._panel = new DataGridPanel(this, 'dashboard-datagrid-panel', 'GP VDC STEEL FABRICATION TAKEOFF', { x: 10, y: 10 });
        this._button = this.createToolbarButton('dashboard-datagrid-button', 'https://img.icons8.com/windows/32/steel-i-beam.png', 'Steel Takeoff');
